...
type WeaviateWellknownLivenessHandlerFunc func(WeaviateWellknownLivenessParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateWellknownLivenessHandlerFunc) Handle(params WeaviateWellknownLivenessParams, principal interface{}) middleware.Responder {
...
type WeaviateWellknownLivenessHandler interface {
	Handle(WeaviateWellknownLivenessParams, interface{}) middleware.Responder
}
