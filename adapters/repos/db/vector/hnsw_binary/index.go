...
type VectorForID func(ctx context.Context, id uint64) ([]byte, error)
...
func (h *hnsw) findBestEntrypointForNode(currentMaxLevel, targetLevel int,
	entryPointID uint64, nodeVec []byte) (uint64, error) {
...
func (h *hnsw) distBetweenNodeAndVec(node uint64, vecB []byte) (float32, bool, error) {
	// TODO: introduce single search/transaction context instead of spawning new
	// ones
