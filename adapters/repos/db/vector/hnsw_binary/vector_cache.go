...
func (n *shardedLockCache) get(ctx context.Context, id uint64) ([]byte, error) {
...
func (n *shardedLockCache) preload(id uint64, vec []byte) {
	n.shardedLocks[id%shardFactor].RLock()
...
//nolint:unused
func (n *noopCache) get(ctx context.Context, id uint64) ([]byte, error) {
