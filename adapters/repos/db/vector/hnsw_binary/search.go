...
import (
	...
	"github.com/semi-technologies/weaviate/adapters/repos/db/vector/hnsw_binary/distancer"
...
func (h *hnsw) SearchByVector(vector []byte, k int, allowList helpers.AllowList) ([]uint64, []float32, error) {
...
func (h *hnsw) searchLayerByVector(queryVector []byte,
...
func (h *hnsw) knnSearchByVector(searchVec []byte, k int,
