...
func (h *hnsw) findNewGlobalEntrypoint(denyList helpers.AllowList, targetLevel int8,
...
// returns entryPointID, level and whether a change occurred
func (h *hnsw) findNewLocalEntrypoint(denyList helpers.AllowList, targetLevel int8,
	oldEntrypoint uint64,
) (uint64, int8) {
	if h.getEntrypoint() != oldEntrypoint {
