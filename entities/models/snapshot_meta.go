...
const (
	...
	// SnapshotMetaStatusRUNNING captures enum value "RUNNING"
	SnapshotMetaStatusRUNNING string = "RUNNING"

	// SnapshotMetaStatusFINISHED captures enum value "FINISHED"
	SnapshotMetaStatusFINISHED string = "FINISHED"
