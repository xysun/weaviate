...
func (m *MightyModule) ClassConfigDefaults() map[string]interface{} {
...
func (m *MightyModule) PropertyConfigDefaults(
...
func (m *MightyModule) ValidateClass(ctx context.Context,
...
func (cv *ConfigValidator) Do(ctx context.Context, class *models.Class,
	...
	// In text2vec-mighty (as opposed to e.g. text2vec-contextionary) the
...
func (cv *ConfigValidator) checkForPossibilityOfDuplicateVectors(
	...
	cv.logger.WithField("module", "text2vec-mighty").
