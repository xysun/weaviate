...
type oldschoolContextualItemClassifier struct {
	item       search.Result
	kind       kind.Kind
...
func (c *oldschoolContextualItemClassifier) do() error {
...
func (c *oldschoolContextualItemClassifier) property(propName string) (string, error) {
...
func (c *oldschoolContextualItemClassifier) classAndKindOfTarget(propName string) (schema.ClassName, kind.Kind, error) {
...
func (c *oldschoolContextualItemClassifier) findTarget(targetClass schema.ClassName, targetKind kind.Kind) (*search.Result, error) {
...
func (c *oldschoolContextualItemClassifier) distance(target []float32) (float64, error) {
